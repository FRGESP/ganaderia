...
CREATE TABLE GUIAENTRADA(
    ...
    Fecha TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    Empleado INT,
    ESTADO ENUM('P', 'A'), -- PENDIENTE O ACABADO
...
CREATE TABLE GUIA(
    ...
    CONSTRAINT FK_GUIATOMOTIVO FOREIGN KEY(Motivo) REFERENCES MOTIVO(IdMotivo)
);
...
CREATE PROCEDURE ADDGUIAENTRADA(IN REEMOIN VARCHAR(30), IN EMPLEADOIN INT)
    BEGIN
        INSERT INTO GUIAENTRADA (REEMO, Empleado, ESTADO) values (REEMOIN, EMPLEADOIN, 'P');
        SELECT 1 AS RES;
    END;
