...
DELETE FROM TEMPGASTOS WHERE Corral = 2;
...
CREATE PROCEDURE ALIMENTARCORRAL(IN CORRALIN INT)
    BEGIN
        ...
        IF((SELECT COUNT(*) FROM TEMPNOSTOCK) = 0) THEN
            ...
            SELECT 1 AS RES;
            ELSE
            SELECT A.Articulo, T.Cantidad FROM TEMPNOSTOCK AS T INNER JOIN ARTICULO AS A ON T.Id = A.IdArticulo WHERE T.Dieta = DIETAVAR ;
        end if;
