      ...
      <PDFExport ref={pdfExportComponent} paperSize="Letter">
        <div className="p-7" hidden={isPrinting}>
          ...
          <div>
            ...
            <p className="text-xl">
              <strong>Nombre:</strong>{inputValue.nombre}
            </p>
            <p className="text-xl">
              <strong>Razon Social:</strong>{inputValue.razonSocial}
            </p>
            <p className="text-xl">
              <strong>Municipio:</strong>{inputValue.municipio}
            </p>
            <p className="text-xl">
              <strong>Localidad:</strong>{inputValue.localidad}
            </p>
            <p className="text-xl">
              <strong>Estado:</strong>{inputValue.estado}
            </p>
          </div>
